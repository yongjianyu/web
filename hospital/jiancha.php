...
//实现分页功能
	$pagesize = 5 ;									//每页显示记录
	//$sqlstr = "select * from patient where ID2 IN (select ID2 from menzhen) order by ID2 desc ";//定义查询语句
...
<div id="container">
	...
	<div id="main">
		...
		<div id="left">
		  ...
		  <div id="main5">
		  <div align="center"><h2>检查表</h2></div>
  			<table border="3px" class="table2"><tr>
                      <th scope="col">ID</th>
                      <th scope="col">姓名</th>
                      <th scope="col">性别</th>
                      <th scope="col">年龄</th>
                    ...
                    <tr>
                      ...
                      <?php echo "<td><a href=jiancha2.php?action=updatepatient&id=".$row[0].">添加/</a><a href=jiancha3.php?id=".$row[0].">修改</a></td>";?>
                    </tr><?php }
					?>
			</table>
			</div>
