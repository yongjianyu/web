  		...
  		<div id="right5">
  		 ...
  		 <li><a href="admin.php">后台管理</a></li>
				...
				<div id="footer" align="center" style="font-size:24px;">
					<input  class="but1" type="submit" name="submit6" value="保存"  />
				...
				<div class="table"  <?php if($_SESSION['fucha']==0){?> style="display:none"<?php } ?>>
				<table width="800px" <?php if($_SESSION['fucha']==0){?> style="display:none"<?php } ?>>
				...
				<div class="table" <?php if($_SESSION['fucha']!=2){?> style="display:none"<?php } ?>>
				<table width="800px" <?php if($_SESSION['fucha']!=2){?> style="display:none"<?php } ?>>
