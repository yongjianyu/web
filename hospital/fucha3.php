...
$sql2 = "select * from aftercheck where ID2 = ".$_GET['id'];
$result2 = mysql_query($sql2,$conn)or die("error");
$row2 = mysql_fetch_array($result2);
$time2= strtotime($time)-strtotime($row2[15]);
if($row2[25]!=$_SESSION['doctorname']&&$_SESSION['flag7']==0){
echo "<script language=\"javascript\">";
...
$sql6 = "select * from checkin where ID2 = ".$_GET['id'];
		   ...
		   <div id="main2">
			...
			<table width="800" border="2px">
					...
					<tr>
						...
						<td colspan="5">
							  位正居中：<input type="checkbox" name="rengongjingti[]" value="位正居中" <?php foreach($rengongjingti as $key){if($key=="位正居中"){?>checked<?php }} ?>>
						
							  位置偏斜：<input type="checkbox" name="rengongjingti[]" value="位置偏斜"<?php foreach($rengongjingti as $key){if($key=="位置偏斜"){?>checked<?php }} ?>>
					...
					<tr>
						<th width="133">人工晶体：</th>
						<td colspan="5">
							  位正居中：<input type="checkbox" name="rengongjingti2[]" value="位正居中" <?php foreach($rengongjingti2 as $key2){if($key2=="位正居中"){?>checked<?php }} ?>>
						
							  位置偏斜：<input type="checkbox" name="rengongjingti2[]" value="位置偏斜"<?php foreach($rengongjingti2 as $key2){if($key2=="位置偏斜"){?>checked<?php }} ?>>
						
							  后囊浑浊<input type="checkbox" name="rengongjingti2[]" value="后囊浑浊"<?php foreach($rengongjingti2 as $key2){if($key2=="后囊浑浊"){?>checked<?php }} ?>>
						
							  机化膜<input type="checkbox" name="rengongjingti2[]" value="机化膜"<?php foreach($rengongjingti2 as $key2){if($key2=="机化膜"){?>checked<?php }} ?>> 
						</td>
					</tr>
					<tr>
						<th width="133">玻璃体：</th>
			...
			<input  class="but1" type="submit" name="submit12" value="保存"  />
			<input  class="but2" type="button" value="返回" onclick="window.location.href='fucha.php'" />
			</div>
				</form>
				<div id="main3">
				<div class="table">
				...
				<tr>
					...
					<tr>
						<th width="133">眼压：</th>
						<td width="133" class="index1"><?php echo $row6[1]; ?></th>
						<th width="133">角膜曲率K1：</td>
						<td width="133" class="index1"><?php echo $row6[2]; ?></th>
						<th width="133">角膜曲率K2：</td>
						<td width="133" class="index1"><?php echo $row6[3]; ?></th>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="133" class="index1"><?php echo $row6[7]; ?></th>
						<th width="133">预留度数：</td>
						<td width="133" class="index1"><?php echo $row6[8]; ?></th>
						<th width="133">验光：</td>
					...
					<tr>
						...
						<th width="133">柱镜：</th>
						<td  class="index1"><?php echo $row6[11]; ?></td>
						<th width="133">轴向：</th>
						<td class="index1"><?php echo $row6[12]; ?></td>
					</tr>
					<tr>
						<th>检查医生：</th>
						<td width="133" class="index1" align="left"><?php echo $row6[13]; ?></td>
					</tr>
					<tr>
						<th>时间日期：</th>
						<td width="133" class="index1" align="left" colspan="2"><?php echo $row6[14]; ?></td>
					</tr>
				</table>
			</div>
					<div class="table">
				...
				<table width="800">
					...
					<tr>
						...
						<td width="133" class="index1"><?php echo $row5[25]; ?></td>
					</tr>
					<tr align="center"><td>右眼</td></tr>
					<tr>
						<th width="133">右眼视力：</th>
					...
					<tr>
						<th>检查医生：</th>
						<td width="133" class="index1" align="left"><?php echo $row5[26]; ?></td>
					</tr>
					<tr>
						<th>时间日期：</th>
						<td width="133" class="index1" align="left" colspan="2"><?php echo $row5[27]; ?></td>
					</tr>
				</table>
				</div>
  		</div>
