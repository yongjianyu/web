...
//实现分页功能
	$pagesize = 5 ;									//每页显示记录
	//$sqlstr = "select * from patient where ID2 IN (select ID2 from chuzhen) order by ID2 desc ";//定义查询语句
	 $sqlstr = "select * from patient order by ID2 desc";
	...
	$result = mysql_query($sqlstr,$conn)or die("error");								//执行查询语句					//循环输出查询结果
?>
<body class="body">
...
<div id="container">
	...
	<div id="main">
		...
		<div id="main5">
		<div align="center"><h2>住院医师表</h2></div>
  			<table  class="table2" border="3px"><tr>
                      <th scope="col">ID</th>
                      <th scope="col">姓名</th>
                      <th scope="col">性别</th>
                      <th scope="col">年龄</th>
                    ...
                    <tr>
                      ...
                      <?php echo "<td><a href=menzhen2.php?action=updatepatient&id=".$row[0].">添加/</a><a href=menzhen3.php?id=".$row[0].">修改</a></td>";?>
                    </tr><?php }
					?>
			</table>
			</div>
			<div style=" width:400px; position:relative; top:-329px; left:620px;">
			<?php
