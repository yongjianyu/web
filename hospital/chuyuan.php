...
//实现分页功能
	$pagesize = 5 ;									//每页显示记录
	//$sqlstr = "select * from patient where ID2 IN (select ID2 from operation) order by ID2 desc ";//定义查询语句
	...
	<div id="main">
		...
		<div id="left"></div>
  		<div id="right">
		   ...
		   <div id="main2">
		   <div align="center"><h2>出院表</h2></div>
  			<table border="3px" class="table2"><tr>
                    ...
                    <tr>
                      ...
                      <?php echo "<td><a href=chuyuan2.php?id=".$row[0].">添加/</a><a href=chuyuan3.php?id=".$row[0].">修改</a></td>";?>
                    </tr><?php }
					?>
			</table>
			</div>
