...
//实现分页功能
	$pagesize = 5 ;									//每页显示记录
	//$sqlstr = "select * from patient where ID2 IN (select ID2 from outcheck) order by ID2 desc ";//定义查询语句
	...
	<div id="main">
		...
		<div id="left"></div>
  		<div id="right">
		   ...
		   <div id="main5">
		   <div align="center"><h2>复查表</h2></div>
  			<table class="table2" border="2px"><tr>
                      <th scope="col">ID</th>
                      <th scope="col">姓名</th>
                      <th scope="col">性别</th>
                      <th scope="col">年龄</th>
                    ...
                    <tr>
                      ...
                      <td class="index1"><?php echo $row[6];?></td>
                       <?php echo "<td><a href=fucha2.php?id=".$row[0].">添加</a></td>";?>
                    </tr><?php }
					?>
			</table>
			</div>
