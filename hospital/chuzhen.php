...
//实现分页功能
	$pagesize = 5 ;									//每页显示记录
	$sqlstr = "select * from patient order by ID2 desc ";//定义查询语句
	...
	<div id="container">
		...
		<div class="logo"></div>
  		...
  		<div id="right">
			...
			<div id="main5">
				<div align="center"><h2>门诊表</h2></div>
				<button id="png" onclick="window.location.href='chuzhen2.php'"></button>
  					<table class="table2" border="3px">
						<tr>
                      		<th scope="col">ID</th>
                     		 <th scope="col">姓名</th>
                    		  <th scope="col">性别</th>
                    ...
                    <tr>
                      ...
                      <?php echo "<td align='center'><a href=chuzhen3.php?id=".$row[0].">修改</a></td>";?>                    </tr><?php }
					?>
				</table>
			</div>
